...
As long as X is less than the difference between the expected present values of damages under Policy A and Policy B (aka \$4.62 x 10\^5), then it would make economic sense to stick with Policy B.
...
If society was risk-adverse in the above scenario, Policy B will still be selected. Policy B is less risky due to the higher probability of the scenario occurring so society would be more willing to pay the X amount.
