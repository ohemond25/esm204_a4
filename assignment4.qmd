...
for (rate in discount_rates) {
  ...
  pv <- npv(rate, warming_damages_df$damages_diff, warming_damages_df$year - 2021) # NOTE: using "damages_diff" column, may need to change to damages_pulse_per_ton
...
TRIAL 2 - WE THINK THIS ONE IS RIGHT BUT LETS COME BACK TO IT
...
damages_polA <- warming_damages_df %>% 
  mutate(pv = npv(0.02, warming_damages_df$damages_baseline, warming_damages_df$year - 2021))
```
